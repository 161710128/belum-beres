			  ...
			  <div class="panel-body">
			  	<form action="{{ route('lowongan.store') }}" method="post" >
			  		...
			  		<div class="form-group {{ $errors->has('gaji') ? ' has-error' : '' }}">
			  			...
			  			<input type="number_format" name="gaji" class="form-control"  required>
			  		...
			  		<div class="form-group {{ $errors->has('deskripsi_iklan') ? ' has-error' : '' }}">
			  			...
			  			<textarea type="text" name="deskripsi_iklan" class="ckeditor" cols="30" rows="20" required></textarea> 
